...
--
-- For MariaDB / MySQL 5.7. If phpMyAdmin's home page says MariaDB or MySQL 5.7,
-- use db/init.hostinger.mariadb.sql instead -- utf8mb4_unicode_ci does not
...
-- On shared hosting the database is created for you in hPanel, and your MySQL
-- user has no rights to create another. Select the database in the left-hand
-- sidebar of phpMyAdmin FIRST, then run this.
