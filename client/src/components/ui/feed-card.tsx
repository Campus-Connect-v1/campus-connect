  ...
  return (
    <View className="bg-white px-4 py-4 rounded-xl mb-3 border border-gray-100">
      ...
      <View className="flex-row items-center mb-3">
        ...
        <View className="flex-1">
          <Text className="text-gray-900 font-semibold text-lg font-[Gilroy-SemiBold]">{post.user.fullName}</Text>
      ...
      {/* Post content */}
      {post.content && (
        <Text className="text-gray-800 mb-3 text-[15px] leading-5 font-[Gilroy-Regular]">
          {post.content}
        </Text>
      )}
