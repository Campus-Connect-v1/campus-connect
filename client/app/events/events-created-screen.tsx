...
interface EventsCreatedScreenProps {
  navigation?: any;
}

const EventsCreatedScreen: React.FC<EventsCreatedScreenProps> = ({ navigation }) => {
  return (
        ...
        <View className="mx-4 mt-4 bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <View className="relative">
            ...
            <View className="absolute top-3 right-3 bg-green-500 px-2 py-1 rounded">
              <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-white text-xs font-semibold">FREE</Text>
            </View>
          </View>

          {/* Event Details */}
          <View className="p-4">
            <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-lg font-semibold text-black mb-2">Advent Tech Networking</Text>
            
            <Text style={{fontFamily: 'Gilroy-Regular'}} className="text-gray-600 text-sm leading-5 mb-4">
              Join us for an exciting networking event where tech enthusiasts, entrepreneurs, and industry professionals come together to share ideas, collaborate, and build meaningful connections.
            </Text>
            ...
            <View className="flex-row">
              ...
              <TouchableOpacity 
                className="flex-1 bg-[#002D69] rounded-full py-3 items-center mr-2"
                onPress={() => router.push('/events/event-details-screen')}
              >
                <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-white text-sm font-semibold">View Details</Text>
              </TouchableOpacity>
              <TouchableOpacity className="flex-1 border border-gray-300 rounded-full py-3 items-center ml-2"
                onPress={() => router.push('/events/create-event-screen')}
              >
                <Text style={{fontFamily: 'Gilroy-SemiBold'}} className="text-gray-700 text-sm font-semibold">Edit Event</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
