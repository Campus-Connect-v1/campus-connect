...
//   const [connectionStatus, setConnectionStatus] = useState<"none" | "pending" | "connected">(data?.user?.connectionStatus || "none")

// //   useEffect(() => {
// //   if (user?.connection_status) {
// //     setConnectionStatus(user.connection_status)
// //   }
...
//     const result = await sendConnectionRequest(data?.user?.user_id)
...
//     }
//     if (result.error) {
//       toast("uniCLIQ", result.error.message, 3000)
//     }
...
//     setIsRequesting(true)
//     const result = await cancelConnectionRequest(data?.user?.user_id)
//     if (result.success) {
//       setConnectionStatus("none")
//     }
//     else{
//       toast("uniCLIQ","Failed to cancel connection request", 3000)
//     }
//     setIsRequesting(false)
//   }
...
//           </TouchableOpacity>
//           <Text style={{ fontFamily: "Gilroy-SemiBold" }} className="text-base font-semibold flex-1 ml-4">
//             Profile
//           </Text>
         
//         </View>

//         <View className="w-full h-80 bg-white rounded-b-full">
//           <Image
//             source={{ uri: user?.profile_picture_url || "https://plus.unsplash.com/premium_photo-1738854510296-116ebc8870e7?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=436" }}
//             className="w-full h-full"
//             resizeMode="cover"
//           />
//         </View>

//         <View className="px-4 py-6 bg-white rounded-t-full w-full">
//           {/* Name, Handle, and Button Row */}
//           <View className="flex-row items-start justify-between mb-6">
//             <View className="flex-1">
//               <Text style={{ fontFamily: "Gilroy-SemiBold" }} className="text-2xl font-bold text-black">
//                 {user?.first_name} {user?.last_name}
//               </Text>
             
//               <Text style={{ fontFamily: "Gilroy-Medium" }} className="text-gray-500 text-base mt-1">
...
//             <View>
//               <TouchableOpacity
//               onPress={data?.user?.connectionStatus === "pending" ? handleCancelRequest : handleConnectionRequest}
...
//                 borderRadius: 28,
//                 marginLeft: 16,
//                 backgroundColor: connectionStatus === "pending" ? "#000000" : "#ef4444", // black or red-500
...
//                 }}
//               >
//                 {isRequesting ? "..." : data?.user?.connectionStatus === "pending" ? "Cancel" : "Follow"}
//               </Text>
//             </TouchableOpacity>
//             </View>
...
//           {/* Stats Section */}
//           <View className="flex-row mb-6 py-4 border-t border-b border-gray-200 justify-between mx-5">
//             <View className="items-center">
//               <Text style={{ fontFamily: "Gilroy-SemiBold" }} className="text-black text-lg font-bold">
//                 {user?.posts_count || 0}
//               </Text>
...
//               <View className="w-20">
//                 <TouchableOpacity onPress={()=>router.push(user.linkedin_url)} className="mb-6 py-3">
//                       <Image
...
//               <View>
//                  <TouchableOpacity onPress={()=>router.push(user.website_url)} className=" mb-6 py-3">
            
//                          <Image
//                     source={require("../../assets/icons/globalization.png")}
//                     style={{ width: 50, height: 50}}
//                   />
...
//           {user?.bio && (
//             <View className="mb-6">
//               <Text style={{ fontFamily: "Gilroy-Regular" }} className="text-gray-700 leading-5 text-base">
//                 {user.bio}
//               </Text>
//             </View>
//           )}
...
//           {/* Media Gallery */}
//           <View className="flex-row justify-between mb-6 py-4 border-t border-gray-200">
...
//             <Text style={{ fontFamily: "Gilroy-SemiBold" }} className="text-lg font-semibold text-black mb-3">
//               About
//             </Text>

//             <View className="mb-4">
//               <Text style={{ fontFamily: "Gilroy-Regular" }} className="text-gray-500 text-sm mb-1">
//                 Program
//               </Text>
